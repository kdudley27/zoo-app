...
storage_url = "https://{}.blob.core.windows.net/".format(app.config['zooapp'])
blob_service = BlobServiceClient(account_url=storage_url, credential=app.config['gzuIGFBudDAoNnsYDZUC21fFMpe6FrZiO7cCZYHltuwvbW0J6z7d1C++au8k9CnK6ME/7Qi6p37Fsn3vvzuCTw=='])
